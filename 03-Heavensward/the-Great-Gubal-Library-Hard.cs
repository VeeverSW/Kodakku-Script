...
public class the_Great_Gubal_Library_Hard
{
    ...
    [ScriptMethod(name: "恐怖眼 - Terror Eye", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:2352"])]
    ...
    [ScriptMethod(name: "定罪 - Condemnation", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:912"])]
    ...
    [ScriptMethod(name: "痛打 - Batter", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:6538"])]
    ...
    [ScriptMethod(name: "黑暗 - Condemnation", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:928"])]
    ...
    [ScriptMethod(name: "双重碎击 - Double Smash", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:618"])]
    ...
    [ScriptMethod(name: "狂水 - Water III", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:5831"])]
    ...
    [ScriptMethod(name: "魔法锤 - Magic Hammer", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:6544"])]
    ...
    [ScriptMethod(name: "停刊 - Discontinue", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:6464"])]
    ...
    [ScriptMethod(name: "骇人嚎叫 - Frightful Roar", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:6459"])]
    ...
    [ScriptMethod(name: "停刊2 - Discontinue2", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:6466"])]
    ...
    [ScriptMethod(name: "AOE提示 - AOE Notify", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:6469"])]
    ...
    [ScriptMethod(name: "突进 - Rush", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:6471"])]
    ...
    [ScriptMethod(name: "刻印 - Seal of Night and Day", eventType: EventTypeEnum.TargetIcon, eventCondition: ["Id:regex:^(0059|0058)$"])]
    public void SealofNightandDay(Event ev, ScriptAccessory sa)
    {
        ...
        if (ev.TargetId == sa.Data.Me)
        {
            ...
            if (ev.Id == 0059)
            {
                msg = language == Language.Chinese ? "站在蓝色地板" : "Stand on Blue tile";
            } else
            {
                msg = language == Language.Chinese ? "站在红色地板" : "Stand on Red tile";
            }
    ...
    [ScriptMethod(name: "地板记录 - tileStore", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(6479|6480)$"])]
    ...
    [ScriptMethod(name: "地板记录1 - tileStore1", eventType: EventTypeEnum.ObjectChanged, eventCondition: ["DataId:regex:^(2007508)$"])]
    ...
    [ScriptMethod(name: "爆震之章 - On the Properties of Quakes", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:(6486)"])]
    ...
    [ScriptMethod(name: "龙卷之章 - On the Properties of Tornados", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:(6487)"])]
    ...
    [ScriptMethod(name: "河童之章 - On the Properties of Imps", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:(6489)"])]
    ...
    [ScriptMethod(name: "AOE提示 - AOE Notify", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:6485"])]
