...
public class MtGulg
{
    ...
    {
        if (isDebug) sa.Log.Debug($"脚本 {Name} v{Version}{DebugVersion} 完成初始化.");
    ...
    #region boss1前
    [ScriptMethod(name: "祭神 - Immolation", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16810"])]
    ...
    [ScriptMethod(name: "尾部碎击 - Tail Smash", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16811"])]
    ...
    [ScriptMethod(name: "天堂斩 - Heavenslash", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16809"])]
    ...
    #region boss2前
    [ScriptMethod(name: "祝圣之光 - Sanctification", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16814"])]
    ...
    [ScriptMethod(name: "惩罚之光 - Punitive Light", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16815"])]
    ...
    #region boss3前
    [ScriptMethod(name: "辉煌右手 - Right Palm", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(16247|16248)$"])]
    ...
    [ScriptMethod(name: "辉煌左手 - Left Palm", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(16249|16250)$"])]
    ...
    [ScriptMethod(name: "死刑提示 - Tankbuster Notify", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:15611"])]
    ...
    [ScriptMethod(name: "流明无限 - Lumen Infinitum", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:16818"])]
    ...
    [ScriptMethod(name: "台风之翼 - Typhoon Wing", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(15616|17153)$"])]
    ...
    [ScriptMethod(name: "飓风之翼 - Hurricane Wing", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:15619"])]
    ...
    [ScriptMethod(name: "AOE提示boss1 - AOE Notify", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:15613"])]
    ...
    [ScriptMethod(name: "AOE提示 - AOE Notify", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:15627"])]
    ...
    [ScriptMethod(name: "解经 - Exegesis", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(16989|15622|16988)$"])]
    ...
    [ScriptMethod(name: "踩塔提示 - boss2 Tower", eventType: EventTypeEnum.ObjectChanged, eventCondition: ["DataId:2009807"])]
    ...
    [ScriptMethod(name: "忏悔 - Perfect Contrition", eventType: EventTypeEnum.AddCombatant, eventCondition: ["DataId:10189"])]
    ...
    [ScriptMethod(name: "AOE提示boss3 - AOE Notify", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:15636"])]
    ...
    [ScriptMethod(name: "加强信音 - Conviction Marcato", eventType: EventTypeEnum.StartCasting, eventCondition: ["ActionId:regex:^(15643|15642|15648)$"])]
    ...
    //[ScriptMethod(name: "定位Boss - Navi to Boss", eventType: EventTypeEnum.SetObjPos, eventCondition: ["SourceDataId:regex:^(10190)$"])]
